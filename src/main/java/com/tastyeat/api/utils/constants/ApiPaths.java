...
public class ApiPaths {
    ...
    public static final String REMOVE_RECIPE_FROM_FAVORITES = "/api/recipe/{recipeId}/remove";
    ...
    public static final String DELETE_RECIPE_REVIEW = "/api/user/{userId}/recipe/{recipeId}/favorite?deletion=true";
